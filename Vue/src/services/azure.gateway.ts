import {
  type FileEntry, type AccessUrls, type AzureResponse,
  type CommandParams,
  isUrlResponse, type RequestParams, type AzureObject,
...
export class AzureGateway {
  ...
  async executeRequest(args: RequestParams | string, commandParams?: CommandParams)
